...
public class SmallEnemyFieldOfView : MonoBehaviour
{
    ...
    SmallEnemyAI enemyAI;

    void Start()
    {
        StartCoroutine(FindTargetsWithDelay(.2f));
        enemyAI = GetComponentInParent<SmallEnemyAI>();
    }
    ...
    private void Update()
    {
        if(visibleTargets.Count > 0) enemyAI.playerTarget = visibleTargets[0];
        else enemyAI.playerTarget = null;
    }
